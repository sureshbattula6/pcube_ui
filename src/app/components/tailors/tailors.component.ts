...
import { TailorCreateComponent } from '../tailors/tailor-create/tailor-create.component';
...
import { FormControl, Validators } from '@angular/forms';
  ...
  createTailor():void{
    ...
    this.dialog.open(TailorCreateComponent,dialogConfig);
  ...
  getData(currentPage, perPage):void{
    ...
    this.TailorsService.GetTailors(params)
