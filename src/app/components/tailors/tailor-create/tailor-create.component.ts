...
@Component({
  selector: 'app-tailor-create',
  templateUrl: './tailor-create.component.html',
  styleUrls: ['./tailor-create.component.css']
})
export class TailorCreateComponent implements OnInit {
 ...
 public current_page:number = CURRENT_PAGE;
  ...
  createTailorForm(){
    this.userForm = this.fb.group({
      ...
      role_id: ['10',[Validators.required]]
    })
  }
  ...
  tailorFormSubmit(){
    ...
    if(this.userId == undefined){
      ...
      this.usersService.storeTailor(this.userForm.value).subscribe(
        (response)=>{
            this.userForm.reset();
