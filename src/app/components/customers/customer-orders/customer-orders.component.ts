...
export class CustomerOrdersComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'order_qty', 'amount','paidAmount','status','actions'];//,'model','color','size','frame_type','collection_type','material','prescription_type','glass_color','frame_width','catalog_no','sap_order_no'
