...
export class DashboardAdminComponent implements OnInit {
  ...
  public orderPlacedCount:number = 0;
  public orderCompletedCount:number = 0;
  public orderCancelledCount:number = 0;
  public ProductsCount:number = 0;
  public SuitsCount:number = 0;
  public ShirtsCount:number = 0;
  public trousersCount:number = 0;
  public topOutfitCount:number = 0;
  ...
  getDashboardDetails(){
    this.commonService.getDashboardDetails().subscribe(
      (res:any) => {
        ...
        this.orderPlacedCount = res.data.orderPlacedCount;
        this.orderCompletedCount = res.data.orderCompletedCount;
        this.orderCancelledCount = res.data.orderCancelledCount;
        ...
        this.topOutfitCount = res.data.topsOutfitCount;
