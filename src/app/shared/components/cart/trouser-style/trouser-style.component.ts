...
@Component({
  selector: 'app-trouser-style',
  templateUrl: './trouser-style.component.html',
  styleUrls: ['./trouser-style.component.css']
})
export class TrouserStyleComponent implements OnInit {
